...
void loop() {
  ...
  run_command(client, "config_subscribe light_grid_setting");
  while (! client.available()) 
    delay(1);

  // Getting the initial value:
  String binary_grid_setting = client.readStringUntil('\n');
  Serial.println("Setting grid setting to " + binary_grid_setting);
  delay(1000);
